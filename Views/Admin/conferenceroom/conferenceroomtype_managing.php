...
<tbody>
  ...
  <tr>
    ...
    <td><a href="?action=edit&id=<?php echo $conferenceroomtypesDto->getcode();?>"><i class="fa fa-edit"></i> Edit</a></td>
	<td><a href="?action=delete&id=<?php echo $conferenceroomtypesDto->getcode();?>"
    	onclick="return confirm ('Delete <?php echo $conferenceroomtypesDto->getcode();?>')"><i class="fa fa-trash"></i> Delete</a></td>
  </tr>
  <?php }?>
  </tbody>
</table>
