...
<title>Add for conference room type</title>
</head>
<style>
	.err {color:red}
</style>
...
<div style="width:400px"> 
  <form method="post" class="pure-form">
	<fieldset>
		<legend><h2>Add conference room type</h2></legend>
		<table align="center" width="100%">
			<tr>
				<td>
                    <label for="conferenceroomcode"><strong>Code:</strong></label><br />
                    <input type="text" name="conferenceroomcode" id="conferenceroomcode" class="pure-input-1"
			...
			<tr>
				<td>
                    ...
                    <input type="text" name="conferenceroomtype" id="conferenceroomtype" autofocus="autofocus" class="pure-input-1"/>
			...
			<tr>
				<td>
                    ...
                    <input type="text" name="pph" id="pph" class="pure-input-3-4"/> &nbsp&nbsp <strong>000 vnd</strong>
